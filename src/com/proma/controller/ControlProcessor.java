	...
	public String [][] getCountCheckedPoints(String [] allPoints) {
		...
		for (int i = allPoints.length; i >= 0; i--){
			...
			switch (allPoints[i]){
				...
				case "3TR": tr3++; break;
				case "4TR+": tr4++; break;
				case "Porosit�" : por++; break;
				case "D�calage" : dec++; break;
				case "Perc�" : per++; break;
				case "P�n�tration" : pen++; break;
			}
		}
		...
		for (String[] element : countCheckedPoints){
			switch (element[0]){
				...
				case "Porosit�" : element[1] = ""+por; break;
				case "D�calage" : element[1] = ""+dec; break;
				case "Perc�" : element[1] = ""+per; break;
				case "P�n�tration" : element[1] = ""+pen; break;
			}
		}
